...
public class Utils {
	...
	public static final long s[][][] = {s0,s1,s2,s3,s4,s5,s6,s7};
	...
	/*Left shifts*/
	public static final int lS[] = {1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1};
	
	public static long s8[][] = {
